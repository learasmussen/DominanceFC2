...
<div class="container">
    ...
    <p class="text-center my-2 text-black font-text fw-bold px-3" id="dominance-fc-partners-text">
        In addition to our sponsors, we work closely with several key partners who help us deliver unforgettable MMA events:
    </p>
</div>
...
<div class="container my-3 my-md-5">
    <div class="row justify-content-center">
        ...
        <div class="col-4 text-center">
            ...
            <p class="fw-bold font-text kbhallen-nordicmedia-text mb-0">Our primary venue, providing us with a fantastic historic arena to host unique MMA shows.</p>
        </div>
        ...
        <div class="col-4 text-center">
            ...
            <p class="fw-bold font-text kbhallen-nordicmedia-text mb-0">Our full-service marketing agency dedicated to driving growth for Dominance FC through effective digital marketing on our website.</p>
        </div>
